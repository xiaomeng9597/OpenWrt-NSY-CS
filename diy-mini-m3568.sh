...
grep -q 'seewo_sv21 \\$' package/boot/uboot-rockchip/Makefile && sed -i "s/seewo_sv21 \\\\/seewo_sv21 \\\\\n    zlg_m3568-evb \\\\/g" package/boot/uboot-rockchip/Makefile || sed -i "s/seewo_sv21/seewo_sv21 \\\\\n    zlg_m3568-evb/g" package/boot/uboot-rockchip/Makefile


echo -e "\\ndefine Device/zlg_m3568-evb
  DEVICE_VENDOR := ZLG
  DEVICE_MODEL := M3568 EVB
  SOC := rk3568
  DEVICE_DTS := rk3568-zlg-m3568
  SUPPORTED_DEVICES := zlg,m3568-evb
  UBOOT_DEVICE_NAME := generic-rk3568
  IMAGE/sysupgrade.img.gz := boot-common | boot-script | pine64-img | gzip | append-metadata
  DEVICE_PACKAGES := kmod-gpio-button-hotplug kmod-nvme kmod-scsi-core kmod-hwmon-pwmfan kmod-thermal kmod-r8168
endef
TARGET_DEVICES += zlg_m3568-evb" >> target/linux/rockchip/image/armv8.mk
